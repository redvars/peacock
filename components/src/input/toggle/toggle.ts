 ...
 *
 * @cssprop --toggle-track-color: Color of the toggle track when checked.
 * @cssprop --toggle-track-off-color: Color of the toggle track when unchecked.
 * @cssprop --toggle-width: Width of the toggle track.
 * @cssprop --toggle-height: Height of the toggle track.
 * @cssprop --toggle-handle-radius: Size of the toggle handle.
 * @cssprop --toggle-handle-color: Color of the toggle handle.
 *
 * @fires {CustomEvent} change - Dispatched when the toggle value changes.
 * @fires {CustomEvent} blur - Dispatched when the toggle loses focus.
 * @fires {CustomEvent} focus - Dispatched when the toggle receives focus.
 *
 * @example
 * ```html
